...
MediaMath (a DSP) has developed the first practical, production-deployed, statistically sound randomization-based methodology for true causal ad effectiveness (or Ad Lift) measurement by a DSP (or similar digital advertising execution system that may not have full control of the underlying RTB auction mechanisms).
